        ...
        <section class="section">
            <div class="container">
                <div class="entertainment">
                    <h2 class="heading-secondary">Entertainment Hubs</h2>
                    ...
                    <p class="entertainment__text">Not fond of Jam Packed Malls? Want to explore the culture of contemporary Raipur? Well then take your ride to Raipur’s Marine Drive. This place flaunts a beautiful lake-The Teliband a Talab which provided magnificent sunset views. Have a penchant for Street food? Look around and you will find a plethora of stalls waiting to cater to your taste buds. If you love art, then you cannot afford to miss a series of vibrant graffiti paintings on various buildings. In a nutshell it is a perfect destination to hang out with friends!! See on <a href="https://goo.gl/maps/sxdtvgMhLTF2">google maps &rarr;</a></p>
                </div>
            </div>
        </section>
        ...
        <section class="section">
            <div class="container">
                <div class="stores">
                    ...
                    <ul class="info__list">
                        <li class="info__item"><strong>Santoshi Nagar</strong>, which is about 7 km from the campus in a 10 min rickshaw ride. See on <a href="https://goo.gl/maps/xRt7CjD5yKk">google maps &rarr;</a></li>
                        <li class="info__item"><strong>Ghadi Chowk</strong>, which is about 10 km from the campus. It is a pivot location due to its proximity with various markets around the city. See on <a href="https://goo.gl/maps/xRt7CjD5yKk">google maps &rarr;</a></li>
                    </ul>
                </div>
            </div>
        </section>
