        ...
        <div id="myModal--1" class="modal">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <li><strong>Important Notice</strong> BTech-2022 Orientation Schedule <a href="Report.pdf" target="_blank" class="notification">Click Here!</a></li>
        ...
        <header class="header header__home">
            <div class="container">
                <div class="header__hero-box">
                    ...
                    <a href="brochure_2022.pdf" class="btn btn-download" download>Brochure 2022&nbsp; <i class="fas fa-download"></i></a><br/>
